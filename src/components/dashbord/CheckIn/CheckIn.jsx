...
//       if (todayAttendance?.checkout?.length > 0) {
//         const checkOutTime = formatTime(todayAttendance.checkout[todayAttendance.checkout.length - 1].out_time);
//         setCheckOutTime(checkOutTime);
//         const totalMinutes = todayAttendance.checkout.reduce((acc, curr) => acc + curr.total_working_minutes, 0);
//         setTotalWorkingMinutes(totalMinutes);
//       } else {
//         setCheckOutTime("");
//         setTotalWorkingMinutes(0);
//       }

//       setCheckIn(todayAttendance?.checkin?.length > todayAttendance?.checkout?.length ? false : true);
//     } catch (error) {
//       console.log(error, "error");
//     }
//   };
...
//       setCheckOutTime(formatTime(response?.data?.out_time));
//       setCheckIn(true);
//       setTotalWorkingMinutes((prevMinutes) => prevMinutes + response?.data?.total_working_minutes);
//     } catch (error) {
//       handleError(error);
//     } finally {
//       setLoading(false);
...
//               <h6>Total Working Time: {formatMinutesToHours(totalWorkingMinutes)}</h6>
//             </div>
//           )}
//         </div>
//       </section>
