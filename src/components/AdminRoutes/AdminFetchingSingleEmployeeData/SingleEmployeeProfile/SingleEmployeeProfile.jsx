...
const SingleEmployeeProfile = ({ employeeProfileData, employeesLists }) => {
  ...
  console.log( employeeProfileData.basic_info ,"basic info");
                    ...
                    <div className="basic-information">
                      <div className="basic-info-left">
                        <div className="info">
                          ...
                          <p>
                            {employeeProfileData?.basic_info.first_name || "no data"}&nbsp;
                            {employeeProfileData?.basic_info.last_name || "no data"}
                          </p>
                        </div>
...
// // Define or import these properties
// let educationDetailsProperties = [
//   {
//     name: "Institute Name",
//     property: "institute_name",
...
//   console.log(employeesLists, "employeesListss");
//   console.log(employeeProfileData, "employeeProfileData");
//   console.log(employeeProfileData.basic_info.first_name, "basic info ");
//  console.log(employeeProfileData.contact_details.personal_email_address, "constact info");
//  console.log(employeeProfileData.dependent_details.name, "dependent info");
// //  console.log(employeeProfileData.educational_details[0].institute_name, "eduscation");
// //  console.log(employeeProfileData.work_experience[0].company_name, "work exipirence");
//  console.log(employeeProfileData.personal_details.about_me, "personal details");
//  console.log(employeeProfileData.work_info.department_name, "work info details");
//   const [status, setStatus] = useState("");
//   const [newClass, setNewClass] = useState("");
//   const [isStatusChanged, setIsStatusChanged] = useState(false);
//   const [currentTab, setCurrentTab] = useState("profile");
...
//   const workExperiences = employeeProfileData.work_experience;
//   // const educational_details = employeeProfileData.educational_details;
//   // const dependent_details = employeeProfileData.dependent_details;
//   const workInfoArray = [work_info];
//   const contactDetailsArray = [contact_details];
//   const identityInfoArray = [identity_info];
//   const personalDetailsArray = [personal_details];
...
//                         <div className="info">
//                           <PiIdentificationBadgeBold />
//                           <p>{employeeProfileData.employee_id}</p>
//                         </div>
//                         <div className="info detail">
//                           <FaPhone />
//                           <p>
//                             {contact_details.personal_mobile_number || "no data"}
//                           </p>
//                         </div>
//                       </div>
//                     </div>
...
//                             <TableHead
//                               tableHeadProperties={educationDetailsProperties}
//                               data={educationDetailsProperties || []}
//                             />
//                           </table>
//                         </div>
//                       </div>
